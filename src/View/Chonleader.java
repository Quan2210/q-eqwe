 ...
 * @author 2XHQ
 */
public class Chonleader extends javax.swing.JFrame {
    public static Chonleader cld = new Chonleader();
    ChonTruongNhom ctm = new ChonTruongNhom();
    public Chonleader() {
        initComponents();
    ...
    private void btnThoatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThoatActionPerformed
        try {
           ...
           ctm.insertDataLop();
            ...
            Logger.getLogger(Chonleader.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Chonleader.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
